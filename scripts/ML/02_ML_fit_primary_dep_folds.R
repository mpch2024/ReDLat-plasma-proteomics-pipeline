...
# 02. Fit fold-specific DEP models
# Requires: Script 01 outputs, reviewer metadata and proteomics
...
FOLDS_DIR <- file.path(ML_CONFIG$private_root, "primary", "00_folds")
data_dir <- ML_CONFIG$data_dir
outdir <- ML_CONFIG$private_root
csv_file <- ML_CONFIG$metadata_file
adat_file <- ML_CONFIG$adat_file
OUT_DIR <- file.path(ML_CONFIG$private_root, "primary", "01_dep_folds")
...
# FOLDS_DIR is defined from ML_CONFIG above; do not override it.
