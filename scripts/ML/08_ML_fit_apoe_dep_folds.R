...
# 08. Fit APOE DEP folds
# Requires: Script 07 outputs, reviewer metadata and proteomics
...
for (fold in 1:5) {
  ...
  cat("\n-------------------------\n")
  cat("Fold:", fold, "\n")
  cat("Train IDs:", nrow(train_ids), "\n")
  cat("\nTotal DEP cohort:", nrow(dep_df), "\n")
  ...
  cat("\nSubjects available for DEP:", nrow(dep_df), "\n")
  cat("Matched IDs:", nrow(dep_df_fold), "\n")
  cat("-------------------------\n")
  ...
  nested_summary[[fold]] <- tibble::tibble(
    Fold = fold,
